#
#  Be sure to run `pod spec lint cordova-plugin-battery-status.podspec' to ensure this is a
#  valid spec and to remove all comments including this before submitting the spec.
#

Pod::Spec.new do |s|
  s.name         = "cordova-plugin-battery-status"
  s.version      = "3.0.0"
  s.summary      = "Mirror of Apache Cordova Plugin battery-status"

  s.description  = <<-DESC
                   A longer description of cordova-plugin-battery-status in Markdown format.
                   DESC

  s.homepage     = "https://github.com/apache/cordova-plugin-battery-status"
