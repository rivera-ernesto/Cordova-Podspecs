#
#  Be sure to run `pod spec lint cordova-plugin-splashscreen.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cordova-plugin-splashscreen in Markdown format.
                   DESC
