#
#  Be sure to run `pod spec lint cordova-plugin-file-transfer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cordova-plugin-file-transfer in Markdown format.
                   DESC
