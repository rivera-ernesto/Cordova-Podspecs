#
#  Be sure to run `pod spec lint cordova-plugin-device-motion.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cordova-plugin-device-motion in Markdown format.
                   DESC
