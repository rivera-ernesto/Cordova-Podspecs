#
#  Be sure to run `pod spec lint cordova-plugin-network-information.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cordova-plugin-network-information in Markdown format.
                   DESC
