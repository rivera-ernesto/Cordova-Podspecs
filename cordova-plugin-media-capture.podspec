#
#  Be sure to run `pod spec lint cordova-plugin-media-capture.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cordova-plugin-media-capture in Markdown format.
                   DESC
