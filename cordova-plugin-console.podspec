#
#  Be sure to run `pod spec lint cordova-plugin-console.podspec' to ensure this is a
#  valid spec and to remove all comments including this before submitting the spec.
#

Pod::Spec.new do |s|
  s.name         = "cordova-plugin-console"
  s.version      = "3.0.0"
  s.summary      = "Mirror of Apache Cordova Plugin console"

  s.description  = <<-DESC
                   A longer description of cordova-plugin-console in Markdown format.
                   DESC

  s.homepage     = "https://github.com/apache/cordova-plugin-console"
